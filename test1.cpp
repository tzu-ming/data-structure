...
for(int i=0;i<row_num;i++){
    for(int j=0;j<col_num;j++){
        if(j<col_num-1){
          ...
          if(dist[i][j]==2147483647){cout<<0<<"  ";}
          else{cout<<dist[i][j]<<"  ";}
        }
        else{
          if(dist[i][j]==2147483647){cout<<0<<endl;}
...
//cout<<min_dist<<" "<<min_dist_row<<" "<<min_dist_col<<endl;
//cout<<block_num<<endl;
//cout<<current_dist<<" "<<current_row<<" "<<current_col<<endl;
//cout<<path1[1][0]<<" "<<path1[2][0]<<endl;
//cout<<path1[1][1]<<" "<<path1[2][1]<<endl;
...
cout<<endl;
for(int i=0;i<=extend-1+return_dist-1;i++){
    cout<<path2[0][i]<<" "<<path2[1][i]<<endl;
}
cout<<total_step;
